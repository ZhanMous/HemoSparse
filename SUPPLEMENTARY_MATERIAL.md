# HemoSparse Supplementary Material

## Privacy-Protected Medical Image Classification with Sparse Spiking Neural Networks
...
2. [5次独立重复实验原始数据](#2-5次独立重复实验原始数据)
3. [影响函数计算完整代码实现](#3-影响函数计算完整代码实现)
4. [高分辨率实验图表](#4-高分辨率实验图表)
